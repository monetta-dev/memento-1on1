...
export default function SessionPage() {
  ...
  const handleEndSession = () => {
    ...
    if (currentSessionData) {
      updateSession(currentSessionData.id, {
        status: 'completed',
        ...
        summary: "Automatic summary generated by AI based on the session transcript. The discussion focused on project delays and managing stakeholder expectations.",
        mindMapData: {
          nodes: nodes,
          edges: edges
        }
      ...
      <Layout>
        ...
        <Content style={{ flex: 2, background: '#000', position: 'relative', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ height: 60, background: '#1f1f1f', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 24 }}>
            ...
            <Button type="primary" danger shape="round" icon={<PhoneOutlined />} onClick={handleEndSession}>
              End Session
            </Button>
          </div>
        </Content>
